...
# tr_pred_dtc = loaded_model.predict(xtrain)
# ts_pred_dtc = loaded_model.predict(xtest)

# test.join(pd.DataFrame(loaded_model.predict(P),columns=["predicted"]))[["prognosis","predicted"]]
